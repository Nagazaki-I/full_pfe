...
const Header = () => {
  ...
  return (
    <div className='mdl:sticky top-0 z-40'> {/* changed z-50 */}
      ...
      <div className='h-10 pb-2 mdl:hidden flex flex-grow px-2 bg-amazon_blue -mt-2'>
        <input className='h-full text-base rounded-l-md text-amazon_blue flex-grow outline-none border-none px-2' type="text" name="" id="" />
        <span className='w-12 h-full flex items-center justify-center bg-amazon_yellow hover:bg-[#f3a847] duration-300 text-amazon_blue cursor-pointer rounded-tr-md rounded-br-md'>
          <SearchIcon />
        </span>
      </div>
